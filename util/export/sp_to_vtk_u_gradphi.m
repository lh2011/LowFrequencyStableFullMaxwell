...
function sp_to_vtk_u_gradphi (u, space_u, phi, space_phi, geometry, npts, filename, fieldname, varargin)

  [eu, F] = sp_eval (u, space_u, geometry, npts, varargin{:});
  [gradphi, F] = sp_eval (phi, space_phi, geometry, npts, 'gradient');

  msh_to_vtk (F, eu+gradphi, filename, fieldname);
